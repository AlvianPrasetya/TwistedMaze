...
struct  ClientSessionInfo_t840  : public Object_t
{
	...
	ByteU5BU5D_t151* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t151* ___masterSecret_5;
};
struct ClientSessionInfo_t840_StaticFields{
