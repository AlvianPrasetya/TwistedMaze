...
struct  ExtendedKeyUsageExtension_t817  : public X509Extension_t705
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t537 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t817_StaticFields{
	...
	Dictionary_2_t131 * ___U3CU3Ef__switchU24map14_4;
};
