...
struct  X509Store_t599  : public Object_t
{
	...
	X509Certificate2Collection_t590 * ___list_2;
	...
	X509Store_t613 * ___store_4;
};
struct X509Store_t599_StaticFields{
	...
	Dictionary_2_t131 * ___U3CU3Ef__switchU24mapF_5;
};
